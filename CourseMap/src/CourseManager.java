...
public class CourseManager {
    ...
    public static void addCourse() {
        boolean done = false;
         //Continue collecting name until Done is typed
        while (!done) {
    ...
    public static void removeCourse() {
        ...
        while (!done) {           //loop will run collected names if courses to remove until Done is typed.
            ...
            if (!courseName.equalsIgnoreCase("done")) {
                if (courseList.remove(courseName.toUpperCase())) {        //this checks whether the courseName actually exists
    ...
    public void generateCourseMap() {
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader("/Users/alex/IdeaProjects/CourseMap/src/course.txt"));
